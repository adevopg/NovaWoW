if (typeof $WH == "undefined") {
    ...
    /* custom */
    var g_host      = 'https://wotlk.novawow.com';
    var g_staticUrl = 'https://wotlk.novawow.com/static';
}
...
if (typeof $WowheadPower == "undefined") {
    var $WowheadPower = new function () {
            ...
            if (url) {
                ...
                if ($WH.in_array(['fr', 'de', 'cn', 'es', 'ru', 'en'], domain) == -1) {
                    for (i in document.scripts) {
                        ...
                        var dmn = document.scripts[i].src.match(/power.js\?(lang|locale)=(en|fr|de|cn|es|ru)/i);
                        if (dmn) {
                            domain = dmn[2];
        ...
        function request(type, id, locale, stealth, params) {
            ...
            $WH.g_ajaxIshRequest(url + "?" + LOOKUPS[type][1] + "=" + id + "&domain=" + localeDomain + "&power" + p + "&v=3");
        ...
        this.refreshLinks = function (id) {
            if (typeof aowow_tooltips != "undefined") {
                var divLinks = document.getElementById(id).getElementsByTagName('a');
